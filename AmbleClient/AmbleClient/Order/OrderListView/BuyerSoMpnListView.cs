...
{
   public class BuyerSoMpnListView:SoMpnListView
    {
       protected override void ViewStart()
       {
            this.Text = "SO Item List for Purchaser";
            tscbList.Items.Add("All SO Item");
            tscbList.Items.Add("My Related SO Item");
        ...
        protected override void FillTheDataGrid()
        {
            ...
            soCombineList= SoMgr.SoMgr.BuyerGetSoCombineAccordingToFilter(UserInfo.UserId, includeSubs, filterColumn, filterString, intStateList);
